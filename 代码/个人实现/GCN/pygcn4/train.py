...
from utils import my_load_data, load_data2,load_flickr,load_youtube, accuracy
...
if args.dataset=="cora":
    ...
    adj, features, labels, idx_train, idx_val, idx_test, my_adj = load_flickr(args.dataset, args.func)
elif args.dataset=="youtube":
    adj, features, labels, idx_train, idx_val, idx_test, my_adj = load_youtube(args.dataset, args.func)
else:
